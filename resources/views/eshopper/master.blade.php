@php
$s = config('eshopper.inc');
$currentRoute = \Route::current()->getName();
$inc = config('eshopper.inc');
@endphp
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="col-md-8 clearfix">
                        <div class="shop-menu clearfix pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><i class="fa fa-lock"></i> <!-- Authentication -->
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        @section('category-products')
                            @include('eshopper.inc.category-products')
                        @show
                        <!--/category-products-->

                        @section('brands_products')
                            @include('eshopper.inc.brands_products')
                        @show
                        <!--/brands_products-->

                        @section('price-range')
                            @include('eshopper.inc.price-range')
                        @show
                        <!--/price-range-->
